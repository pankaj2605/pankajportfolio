          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<IoLogoNodejs />} name={"NodeJS"} value={70} />
                <ProgressBar logo={<FaReact />} name={"React Js"} value={65} />
                <ProgressBar logo={<BsFiletypeSql />} name={"MySQl"} value={60} />
                <ProgressBar
                  logo={<IoLogoCss3 />}
                  name={"CSS"}
                  value={50}
                />
                <ProgressBar logo={<SiExpress />} name={"Express Js"} value={70} />
                <ProgressBar
                  logo={<SiTailwindcss />}
                  name={"Tailwind CSS"}
                  value={80}
                />
                <ProgressBar logo={<SiMongodb />} name={"MongoDB"} value={65} />
